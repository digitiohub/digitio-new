...
export function Navbar() {
    ...
    const navLinks = [
        { name: "About", href: "/about", desc: "Who we are" },
        ...
        >
            ...
            <div className="flex items-center gap-4">
                ...
                <Sheet>
                    ...
                    <SheetContent side="right" className="bg-[#0a0a0a] border-white/10 text-white w-full sm:max-w-md p-0 flex flex-col overflow-hidden">
                        ...
                        <SheetHeader className="p-8 pb-4 text-left border-b border-white/5">
                            <SheetTitle className="text-white">
                                <Image src="/logos/Digi_Logo_Full_Cropped_White.png" alt="DigitioHub Logo" width={120} height={32} className="object-contain" />
                            </SheetTitle>
                        ...
                        <div className="flex-1 overflow-y-auto px-6 py-8">
                                    ...
                                    <SheetClose key={link.name} asChild>
                                        ...
                                        >
                                            <div className="flex flex-col">
                                                <span className="text-xl font-bold tracking-tight text-white group-hover:translate-x-1 transition-transform">{link.name}</span>
                                                <span className="text-xs text-white/40 group-hover:text-white/60 transition-colors">{link.desc}</span>
                                            </div>
                            ...
                            <div className="mt-12 px-2">
                                <p className="text-[10px] font-bold text-white/20 uppercase tracking-[0.2em] mb-6">Stay Connected</p>
                                <div className="flex gap-4">
                                    {[Instagram, Linkedin, Twitter].map((Social, i) => (
                                        <Link key={i} href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white hover:bg-white/10 hover:border-white/20 transition-all">
