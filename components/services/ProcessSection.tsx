        ...
        <section className="relative px-6 py-20 md:py-32 lg:py-0 lg:h-screen lg:min-h-[850px] border-t border-white/10 flex items-center">
            <div className="container mx-auto max-w-7xl">
                <div className="max-w-3xl mb-24 reveal">
                    ...
                    <h2 className="text-4xl md:text-6xl font-medium leading-tight">How we build the future.</h2>
                </div>
                    ...
                    {processSteps.map((step) => (
                        <div key={step.id} className="reveal group">
                            <div className="mb-6 flex items-baseline gap-4">
                                ...
                                <div className="h-px flex-1 bg-white/10 group-hover:bg-blue-500/50 transition-colors" />
                            </div>
