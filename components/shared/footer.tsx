...
const footerGroups = [
    {
        ...
        links: [
            ...
            { label: "Sectors", href: "/portfolio#sector-grid" },
...
const socialLinks = [
    {
        label: "Instagram",
        href: "https://www.instagram.com/digitiohub",
        icon: Instagram,
    },
    {
        label: "LinkedIn",
        href: "https://www.linkedin.com/company/digitiohub/",
        icon: Linkedin,
    },
    {
        label: "YouTube",
        href: "https://www.youtube.com/@DigitioHub",
        icon: Youtube,
    },
];
...
const contactInfo = [
    ...
    {
        label: "Address",
        value: "Room No. 520, Bhaskarachraya Building, Somaiya Vidyavihar, Vidyavihar (E), Mumbai, Maharashtra 400077",
                ...
                <div className="grid gap-10 lg:grid-cols-3">
                    ...
                    <div>
                        ...
                        <p className="mt-6 text-sm text-white/55">
                            &copy; Copyright DigitioHub 2026. All rights
                            reserved.
                        </p>
                    ...
                    <div className="mt-10 lg:mt-0 lg:text-right">
                        <div className="space-y-2">
                            <h3 className="text-base font-semibold tracking-tight text-white/95 mb-2">
                                Contact
                            </h3>
