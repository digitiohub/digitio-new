        ...
        <div className="p-8 md:p-10">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              ...
              <div className="flex flex-wrap gap-4 pt-2">
                {product.features.slice(0, 3).map((feature, i) => (
                  <div key={i} className="flex items-center gap-2 text-sm text-neutral-300">
                    <CheckCircle2 className="w-4 h-4" style={{ color: product.theme.accent }} />
                    <span>{feature}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <Button
                ...
                className={cn(
                  "rounded-full px-6 py-6 border-white/10 bg-white/5 hover:bg-white/10 transition-all text-white",
          ...
          <AnimatePresence>
            {isExpanded && (
              ...
              >
                <div className="pt-12 grid grid-cols-1 md:grid-cols-2 gap-10 border-t border-white/5 mt-10">
                  {/* Problem & Solution */}
                  ...
                  <div className="space-y-8 p-6 rounded-2xl bg-white/5 border border-white/5">
                    <div>
